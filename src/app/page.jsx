    ...
    <>
      <Container className="mt-24">
        <FadeIn className="max-w-3xl">
          <h1 className="font-display mb-12 text-5xl font-medium tracking-tight [text-wrap:balance] text-neutral-950 sm:text-7xl">
      ...
      <Testimonial className="mt-24 sm:mt-32 lg:mt-40">
        The therapist&apos;s touch is light with craniosacral therapy and
        intended to optimize freedom within the intricate web of bones, muscles,
        soft tissues and fluid that makes us who we are.
      </Testimonial>
      ...
      <Container className="mt-24 text-center sm:mt-32 lg:mt-40">
        <FadeIn>
          <Image
            ...
            sizes="(min-width: 640px) 600px, calc(100vw - 3rem)"
            className="m-auto h-auto w-[600px] max-w-full"
          />
        </FadeIn>
      </Container>
